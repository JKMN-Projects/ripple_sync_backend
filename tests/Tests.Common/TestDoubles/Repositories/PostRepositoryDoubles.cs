...
public static class PostRepositoryDoubles
{
    public class Dummy : IPostRepository
    {
        ...
        public Task RemoveScheduleOnAllPostsWithoutEventAsync(Guid userId, CancellationToken cancellationToken = default) => throw new NotImplementedException();
    }
    ...
    public sealed class Composite : IPostRepository
    {
        ...
        public Task RemoveScheduleOnAllPostsWithoutEventAsync(Guid userId, CancellationToken cancellationToken = default)
            => TryMethod(repo => repo.RemoveScheduleOnAllPostsWithoutEventAsync(userId, cancellationToken));
    }
